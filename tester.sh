...
printf ${BLUE}"| $$$$$$$  /$$  /$$$$$$ | $$$$$$$   /$$$$$$  /$$   /$$| $$  /$$$$$$  /$$$$$$$$        /$$_/  \_  $$       | $$  | $$|__/  \ $$| $$ /$$/ | $$      \n"${DEF_COLOR};
printf ${BLUE}"| $$__  $$| $$ /$$__  $$| $$__  $$ /$$__  $$| $$  | $$| $$ /$$__  $$|____ /$$/       /$$/ /$$$$$  $$      | $$$$$$$$  /$$$$$$/| $$$$$/  | $$      \n"${DEF_COLOR};
printf ${BLUE}"| $$  \ $$| $$| $$  \ $$| $$  \ $$| $$  \__/| $$  | $$| $$| $$$$$$$$   /$$$$/       | $$ /$$  $$| $$      |_____  $$ /$$____/ | $$  $$  | $$      \n"${DEF_COLOR};
printf ${BLUE}"| $$  | $$| $$| $$  | $$| $$  | $$| $$      | $$  | $$| $$| $$_____/  /$$__/        | $$| $$\ $$| $$            | $$| $$      | $$\  $$ | $$      \n"${DEF_COLOR};
printf ${BLUE}"| $$  | $$| $$|  $$$$$$$| $$  | $$| $$      |  $$$$$$/| $$|  $$$$$$$ /$$$$$$$$      | $$|  $$$$$$$$/            | $$| $$$$$$$$| $$ \  $$| $$$$$$$$\n"${DEF_COLOR};
printf ${BLUE}"|__/  |__/|__/ \____  $$|__/  |__/|__/       \______/ |__/ \_______/|________/      |  $$\________/             |__/|________/|__/  \__/|________/\n"${DEF_COLOR};
printf ${BLUE}"               /$$  \ $$                                                             \  $$$   /$$$                                                \n"${DEF_COLOR};
printf ${BLUE}"              |  $$$$$$/                                                              \_  $$$$$$_/                                                \n"${DEF_COLOR};
