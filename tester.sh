...
printf ${BLUE}" ________  ________  ________  ________     _______  ________  _______   ________  ________  ________  _________    "${DEF_COLOR};
printf ${BLUE}"|\   __  \|\   __  \|\   __  \|\   ___  \  /  ___  \|\   __  \|\  ___ \ |\   __  \|\   __  \|\   __  \|\___   ___\  "${DEF_COLOR};
printf ${BLUE}"\ \  \|\ /\ \  \|\  \ \  \|\  \ \  \\ \  \/__/|_/  /\ \  \|\ /\ \   __/|\ \  \|\  \ \  \|\  \ \  \|\  \|___ \  \_|  "${DEF_COLOR};
printf ${BLUE}" \ \   __  \ \  \\\  \ \   _  _\ \  \\ \  \__|//  / /\ \   __  \ \  \_|/_\ \   _  _\ \  \\\  \ \  \\\  \   \ \  \   "${DEF_COLOR};
printf ${BLUE}"  \ \  \|\  \ \  \\\  \ \  \\  \\ \  \\ \  \  /  /_/__\ \  \|\  \ \  \_|\ \ \  \\  \\ \  \\\  \ \  \\\  \   \ \  \  "${DEF_COLOR};
printf ${BLUE}"   \ \_______\ \_______\ \__\\ _\\ \__\\ \__\|\________\ \_______\ \_______\ \__\\ _\\ \_______\ \_______\   \ \__\ "${DEF_COLOR};
printf ${BLUE}"    \|_______|\|_______|\|__|\|__|\|__| \|__| \|_______|\|_______|\|_______|\|__|\|__|\|_______|\|_______|    \|__| "${DEF_COLOR};
...
printf ${BLUE}"\n-------------------------------------------------------------\n"${DEF_COLOR};
printf ${YELLOW}"\n\t\tALL GREEN? YOU'RE AWESOME. "${DEF_COLOR};
printf ${CYAN}"GOT RED? HAHA IN YOUR FACE\t\n"${DEF_COLOR};
printf ${BLUE}"\n-------------------------------------------------------------\n"${DEF_COLOR};
