...
printf ${BLUE}" ________  ________  ________  ________     _______  ________  _______   ________  ________  ________  _________    \n"${DEF_COLOR};
printf ${BLUE}"|\   __  \|\   __  \|\   __  \|\   ___  \  /  ___  \|\   __  \|\  ___ \ |\   __  \|\   __  \|\   __  \|\___   ___\  \n"${DEF_COLOR};
printf ${BLUE}"\ \  \|\ /\ \  \|\  \ \  \|\  \ \  \\ \  \/__/|_/  /\ \  \|\ /\ \   __/|\ \  \|\  \ \  \|\  \ \  \|\  \|___ \  \_|  \n"${DEF_COLOR};
printf ${BLUE}" \ \   __  \ \  \\\  \ \   _  _\ \  \\ \  \__|//  / /\ \   __  \ \  \_|/_\ \   _  _\ \  \\\  \ \  \\\  \   \ \  \   \n"${DEF_COLOR};
printf ${BLUE}"  \ \  \|\  \ \  \\\  \ \  \\  \\ \  \\ \  \  /  /_/__\ \  \|\  \ \  \_|\ \ \  \\  \\ \  \\\  \ \  \\\  \   \ \  \  \n"${DEF_COLOR};
printf ${BLUE}"   \ \_______\ \_______\ \__\\ _\\ \__\\ \__\|\________\ \_______\ \_______\ \__\\ _\\ \_______\ \_______\   \ \__\ \n"${DEF_COLOR};
printf ${BLUE}"    \|_______|\|_______|\|__|\|__|\|__| \|__| \|_______|\|_______|\|_______|\|__|\|__|\|_______|\|_______|    \|__| \n"${DEF_COLOR};
